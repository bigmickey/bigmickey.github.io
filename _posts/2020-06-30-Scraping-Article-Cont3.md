...
So far, do good but what will cheerio do for us? One of its most useful features is to make a jQuery-like search to return useful parts of the DOM. Let's do a quick example:
